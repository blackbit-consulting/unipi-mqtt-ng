...
evok:
  ...
  options: # Options for the Evok device
    version: v2 # The version of the Evok API to use. This can be used to support both Evok 2 and Evok 3, which have some differences in messages and types. Default is v2.
